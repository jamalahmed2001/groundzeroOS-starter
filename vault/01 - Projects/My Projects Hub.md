...
**UP:** [[00 - Dashboard/Dashboard|Dashboard]]

# My Projects Hub

> Every project lives under here. Each project is a self-contained bundle (Overview + Phases Hub + Knowledge + per-phase notes). Forking a starter is the fastest way to begin a new project.

## Starter projects (fork these)

The repo ships six starter projects covering the common work shapes. Each is a complete bundle — fork it, fill in your specifics, run.

| Starter | Profile | Phases | What it demonstrates |
|---|---|---|---|
...
See [`PIPELINES.md`](../../PIPELINES.md) at the repo root for the full index + decision tree on which starter to pick.

## Your projects

(As you fork starters, your real projects accumulate here.)
